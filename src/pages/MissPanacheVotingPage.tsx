...
import MissPanacheHero from "@/assets/MissPanache.jpeg";
import {
  ArrowLeft,
  Award,
  Loader2,
...
const matchesSearch = (nominee: MissPanacheNomineeWithCategory, query: string) => {
  const haystack = [
    nominee.name,
...
const alphabetizeCategories = (categories: MissPanacheAwardCategory[]) =>
...
const buildOverallRankMap = (categories: MissPanacheAwardCategory[]) => {
...
const getCategoryVoteTotal = (category: MissPanacheAwardCategory) =>
  category.nominees.reduce(
    (total, nominee) => total + getMissPanacheVoteCount(nominee),
    0
  );
  ...
  return (
    <article className="flex h-full flex-col rounded-[1.8rem] border border-black/8 bg-white p-5 shadow-[0_18px_44px_rgba(17,16,14,0.07)]">
      ...
      <div className="mt-auto pt-5">
        ...
        >
          <Link to={getMissPanacheCategoryVoteUrl(category.slug)}>
            View category
          </Link>
        </Button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#f4f3ef]">
      ...
      <main className="pb-20 pt-24 md:pb-24">
        <section className="mx-auto grid max-w-7xl gap-10 px-6 md:px-10 lg:grid-cols-[0.56fr_0.44fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              >
                <a href="#contestants">Choose contestants</a>
              </Button>
              <Button
                asChild
                variant="outline"
        ...
        <section id="contestants" className="mx-auto mt-14 max-w-7xl px-6 md:px-10">
          {isLoading ? (
            ...
            <>
              <div className="rounded-[2rem] border border-black/8 bg-white p-5 md:p-6">
                <div className="grid gap-5 lg:grid-cols-[0.5fr_0.5fr] lg:items-center">
                  <div>
                    <Link
                      to="/panache-expo/miss-panache/vote"
            ...
            <>
              ...
              {categories.length ? (
                ...
                <div className="mt-8 rounded-[2rem] border border-dashed border-black/12 bg-white px-6 py-10 text-center">
                  <p className="font-sans text-sm text-[#171411]/68">
                    No public Miss Panache categories are available yet.
                  </p>
                </div>
              )}
            </>
