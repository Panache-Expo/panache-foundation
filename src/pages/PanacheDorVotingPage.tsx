...
const matchesSearch = (nominee: PanacheDorNomineeWithCategory, query: string) => {
  const haystack = [
    nominee.name,
  ...
  return (
    <article className="flex h-full flex-col rounded-[1.8rem] border border-black/8 bg-white p-5 shadow-[0_18px_44px_rgba(17,16,14,0.07)]">
      <div>
        ...
        {category.description ? (
          ...
          <p className="mt-3 font-sans text-sm leading-relaxed text-[#171411]/62">
            Choose this category to see the nominees and support your favorite.
          </p>
        )}
      ...
      <div className="mt-auto pt-5">
        ...
        >
          <Link to={getPanacheDorCategoryVoteUrl(category.slug)}>
            View category race
          </Link>
        </Button>
      </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              {visibleNominees.length ? (
                ...
                <div className="mt-8 rounded-[2rem] border border-dashed border-black/12 bg-white px-6 py-10 text-center">
                  <p className="font-sans text-sm text-[#171411]/68">
                    No nominees in this category match the current search.
                  </p>
                </div>
              )}
            </>
            ...
            <>
              ...
              {categories.length ? (
                ...
                <div className="mt-8 rounded-[2rem] border border-dashed border-black/12 bg-white px-6 py-10 text-center">
                  <p className="font-sans text-sm text-[#171411]/68">
                    No public Panache D&apos;or categories are available yet.
                  </p>
                </div>
              )}
            </>
